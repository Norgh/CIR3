...
;     <Insert High Priority ISR Here - no SW context saving>
    ...
    BTFSS INTCON, INT0IF ;se met à 1 dès interruption, skip si 1
    GOTO fin
    
    BTFSS marche_arret, 0 ;on compare le bit 0
    GOTO zero
    GOTO un
    
zero
    BSF marche_arret, 0
    BSF T0CON, TMR0ON ;active le timer
    GOTO fin
    
un
    BCF marche_arret, 0
    BCF T0CON, TMR0ON ;arrêt du timer
    GOTO fin
 
fin
    BCF INTCON, INT0IF ;rend l'interruption à nouveau disponible 
    RETFIE  FAST
;
